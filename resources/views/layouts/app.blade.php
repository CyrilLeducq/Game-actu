...
<body class="font-[Nunito] flex flex-col justify-between h-screen">
        ...
        <div class="max-w-5xl mx-auto px-3">
            <div class="flex justify-between items-center">
                ...
                <nav class="space-x-3">
                    ...
                    <a class="hover:underline underline-offset-8" href="/jeux">Jeux</a>
                    <a class="hover:underline underline-offset-8" href="/plateformes">Consoles</a>
    ...
    <footer class="bg-gray-800 text-gray-300 py-8">
        <div class="max-w-5xl mx-auto px-3">
            <p class="text-center text-xl">Game Actu &copy; {{ date('Y') }}</p>
        </div>
    </footer>
</body>
</html>